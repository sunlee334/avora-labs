...
### 모바일에서는 푸터가 유일한 통로입니다

헤더 링크는 900px 미만에서 숨겨집니다(`.nav__links { display: none }`).
현재 이 사이트에는 햄버거 메뉴가 없어, 모바일에서 고객센터·브랜드 스토리·제품에
가는 길은 푸터뿐입니다. 테스트가 푸터 링크를 확인합니다.
...
| 브라우저 테스트 | 전부 통과 | **1,080개 통과** (commerce 720 + launch 360) |
